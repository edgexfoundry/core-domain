...
public class Schedule extends BaseObject {
	...
	// cron styled regular expression indicating how often the action under schedule should occur.  Use either runOnce, frequency or cron and not all.
	private String cron;
	
	// boolean indicating that this schedules runs one time - at the time indicated by the start
	private boolean runOnce;

	public Schedule(String name, String start, String end, String frequency, String cron, boolean runOnce) {
		super();
		this.name = name;
		this.start = start;
		this.end = end;
	...
	public String toString() {
		return "Schedule [name=" + name + ", start=" + start + ", end=" + end + ", frequency=" + frequency + ", cron="
				+ cron + ", runOnce=" + runOnce + ", toString()=" + super.toString() + "]";
	}
