...
public class ProvisionWatcher extends BaseObject {
	...
	// set of key value pairs that identify type of of address (MAC, HTTP,...)
	// and address to watch for (00-05-1B-A1-99-99, 10.0.0.1,...)
	...
	public String toString() {
		return "ProvisionWatcher [id=" + this.getId() + ", name=" + name + ", identifiers=" + identifiers + ", service=" + service + ", profile=" + profile + ", operatingState=" + operatingState.name() + "]";
	}
