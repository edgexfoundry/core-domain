...
public abstract class Action {
	...
	/**
	 * Convenience method to return a list of all expected values from all the
	...
	/**
	 * Convenience method to return the names of all associated value descriptor
	 * names. For Get this is just expected value names. For Put, this is
	 * expected value names plus parameter names.
	 * 
	 * @return
	 */
