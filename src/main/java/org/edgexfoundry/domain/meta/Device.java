...
public class Device extends DescribedObject implements Asset {
	...
	public String toString() {
		return "Device [name=" + name + ", adminState=" + adminState + ", operatingState=" + operatingState
				+ ", addressable=" + addressable + ", lastConnected=" + lastConnected + ", lastReported=" + lastReported
				+ ", labels=" + Arrays.toString(labels) + ", location=" + location + ", service=" + service
				+ ", profile=" + profile + "]";
	}
