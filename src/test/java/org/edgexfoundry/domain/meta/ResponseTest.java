...
public class ResponseTest {
  ...
  public void testAddExpectedValue() {
    ...
    assertEquals("Expected values list was not added to appropriately", 3,
        r.getExpectedValues().size());
  }

  @Test
  public void testRemoveExpectedValue() {
    r.removeExpectedValue(TEST_VALUE1);
    assertEquals("Expected value was not removed from list appropriately", 1,
        r.getExpectedValues().size());
  }
