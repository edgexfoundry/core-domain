...
public class PutTest {
  ...
  @Test
  public void testAddParameterNameStartingWithNull() {
    p.setParameterNames(null);
    p.addParameterName(PARAM2);
    assertEquals("Put parameters not adding correctly", 1, p.getParameterNames().size());
  }
  ...
  @Test
  public void testRemoveParemeterNameStartingWithNull() {
    p.setParameterNames(null);
    p.removeParemeterName(PARAM1);
    assertTrue("Put remove parameter not working correctly", p.getParameterNames().isEmpty());
  }
  ...
  @Test
  public void testGetParameterNamesStartingWithNull() {
    p.setParameterNames(null);
    assertTrue("Get parameter names not working correctly", p.getParameterNames().isEmpty());
  }
